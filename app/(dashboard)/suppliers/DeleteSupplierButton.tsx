...
export default function DeleteSupplierButton({ id, name }: Props) {
              ...
              <div style={{ display: 'flex', gap: 'var(--sp-3)', alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <p style={{ margin: '6px 0 0', color: 'var(--gray-500)', fontSize: 13 }}>
                    The supplier will be soft-deleted. If they are referenced by
                    any purchases the deletion will be blocked.
                  </p>
                </div>
              </div>
            </div>
