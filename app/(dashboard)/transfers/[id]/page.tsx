...
import {
  ...
  Warehouse, Mail, Smartphone, MapPin,
} from 'lucide-react';
    ...
    <>
      ...
      <div className="page-head">
        ...
        <div style={{ display: 'flex', gap: 'var(--sp-3)' }}>
          <Link href={`/transfers/${id}/pdf`} className="gg-btn gg-btn--secondary gg-btn--sm">
            <FileDown size={16} /> Download PDF
          </Link>
          <Link href={`/transfers/${id}/edit`} className="gg-btn gg-btn--secondary gg-btn--sm">
            <Pencil size={15} /> Edit
          </Link>
          ...
          <div className="pur-info-panel">
            ...
            <div className="pur-info-body">
              ...
              <div className="pur-info-line">
                ...
                <span className="v gg-num" style={{ fontSize: 12 }}>{fmtDateTime(transfer.createdAt)}</span>
              </div>
            </div>
          </div>
