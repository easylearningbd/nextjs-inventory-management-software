...
export default async function ViewPurchaseReturnPage({
  params,
}: {
    ...
    <>
      ...
      <div className="page-head pur-noprint">
        ...
        <div style={{ display: 'flex', gap: 'var(--sp-3)' }}>
          <Link
            href={`/purchases/returns/${id}/pdf`}
            className="gg-btn gg-btn--secondary gg-btn--sm"
          >
            <FileDown size={16} /> Download PDF
          </Link>
          <Link
            href={`/purchases/returns/${id}/edit`}
            className="gg-btn gg-btn--secondary gg-btn--sm"
          >
            <Pencil size={15} /> Edit
          </Link>
          <Link href="/purchases/returns" className="gg-btn gg-btn--secondary gg-btn--sm">
      ...
      <div className="gg-card gg-card-pad">
          ...
          <div className="pur-info-panel">
            ...
            <div className="pur-info-body">
              ...
              <div className="pur-info-line">
                ...
                <span className="v gg-num" style={{ color: 'var(--success-fg)' }}>{fmt(paid)}</span>
              </div>
              <div className="pur-info-line">
                <span className="k">Due :</span>
                <span className="v gg-num" style={{ color: due > 0 ? 'var(--danger)' : undefined }}>{fmt(due)}</span>
              </div>
              <div className="pur-info-line">
        ...
        <div className="pur-totals-box">
          ...
          <div className="pur-totals-row">
            ...
            <span className="ptr-val gg-num" style={{ color: 'var(--success-fg)' }}>{fmt(paid)}</span>
          </div>
          <div className="pur-totals-row">
            <span className="ptr-lbl">Due</span>
            <span className="ptr-val gg-num" style={{ color: due > 0 ? 'var(--danger)' : undefined }}>{fmt(due)}</span>
          </div>
        </div>
